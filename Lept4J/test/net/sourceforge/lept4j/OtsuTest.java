...
public class OtsuTest {
    ...
    public void testOtsu() throws Exception {
        ...
        pixs = Leptonica1.pixRead("test/1555-7.jpg");
        ...
        for (int i = 0; i < 3; i++) {
            ...
            textstr = String.format("test/test-results/otsu.%d.png", i);
        ...
        Leptonica1.pixWrite("test/test-results/otsu-tiled.jpg", pixb, IFF_PNG);
        pixDestroy(pixb);
        pixaDestroy(pixa);
