...
public class ImageViewer {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					File opencvLibrary = new File("./lib/opencv300/build/java/x64/opencv_java300.dll");
	...
	public void displayImage() {
		SwingUtilities.invokeLater(new Runnable() {
	      public void run() {
			 ...
			 //instance.setTessVariable("tessedit_char_whitelist", "CENWDLGKYDHMSORTX1234567890-");
	...
	private void initialize() {
		...
		sqlDataArea.setBounds(10, 125, 295, 230);
